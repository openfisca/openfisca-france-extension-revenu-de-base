...
def build_reform(tax_benefit_system):
    ...
    reform_legislation_json['children']['cotsoc']['children']['exo_bas_sal']['children']['fillon']['children']['tx_max']['values'][0]['value'] = 0.2075
    reform_legislation_json['children']['cotsoc']['children']['exo_bas_sal']['children']['fillon']['children']['tx_max2']['values'][0]['value'] = 0.2285
    reform_legislation_json['children']['cotsoc']['children']['exo_bas_sal']['children']['fillon']['children']['tx_max2']['values'][1]['value'] = 0.2075
    # import sys, json
    # with open('legislation.json', 'w') as file:
    #     file.write(json.dumps(reform_legislation_json))
    # sys.exit(0)
